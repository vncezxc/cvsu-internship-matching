...
def _draw_report_footer(canvas_obj, request):
    """Draw a consistent footer on PDF reports."""
    generated_by = request.user.get_full_name() or request.user.username

    canvas_obj.setFillColor(colors.black)
    canvas_obj.setFont('Helvetica', 9)
    canvas_obj.drawString(40, 20, f'Generated by: {generated_by}')
